  ...
  return (
    <div>
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="text-[15px]" dangerouslySetInnerHTML={{ __html: blog.content }} />
      </div>
      ...
      <div className="mt-8 font-inter">
        <h2 className="text-2xl font-semibold mb-4 text-center font-inter">You May Also Like</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {relatedBlogs.map((relatedBlog) => (
            <div key={relatedBlog.id} className="bg-white p-4 rounded-lg shadow-md">
